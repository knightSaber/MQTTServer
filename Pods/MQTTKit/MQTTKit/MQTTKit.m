...
- (void)connectWithCompletionHandler:(NSString *)name andPassword:(NSString *)password andCallBack:(void (^)(MQTTConnectionReturnCode))completionHandler{
...
- (void) connectWithCompletionHandler:(void (^)(MQTTConnectionReturnCode code))completionHandler {
    ...
    if (self.username)
        cstrUsername = [@"cbt" cStringUsingEncoding:NSUTF8StringEncoding];
    
    if (self.password)
        cstrPassword = [@"123" cStringUsingEncoding:NSUTF8StringEncoding];
...
- (void)connectToHost:(NSString *)host andName:(NSString *)name andPassword:(NSString *)password
    completionHandler:(void (^)(MQTTConnectionReturnCode code))completionHandler{

    self.host = host;
//    [self connectWithCompletionHandler:completionHandler];
    
    [self connectWithCompletionHandler:name andPassword:password andCallBack:completionHandler];
